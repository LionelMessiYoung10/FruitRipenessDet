...
"border-radius:40px;")
        ...
        self.label_log_info.setGeometry(QRect(162, 400, 179, 39))
...
"background-color: transparent;")
        ...
        self.label_pic_reg.setStyleSheet(u"border-image: url(./icons/user.png);\n"
"background-color: transparent;\n"
"border-radius:40px;")
...
"background-color: transparent;")
        ...
        self.label_reg_info.setGeometry(QRect(158, 402, 179, 39))
