...
from QtFusion.styles import loadYamlSettings
...
class RecMainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None, *args, **kwargs):
        ...
        QWindowCtrls(self, exit_title="基于机器学习和图像处理的苹果识别系统",  # 退出确认框标题
        ...
        qss_path = abs_path("themes/main_text_black.qss", path_type="current")
        ...
        self.count_name = ["新鲜苹果", "腐烂苹果", "半熟苹果", "半腐烂苹果", "新鲜香蕉", "腐烂香蕉", "半熟香蕉",
                           "半腐烂香蕉",
                           "新鲜芒果", "腐烂芒果", "半熟芒果", "半腐烂芒果", "新鲜瓜类", "腐烂瓜类", "半熟瓜类",
                           "半腐烂瓜类",
                           "新鲜橙子", "腐烂橙子", "半熟橙子", "半腐烂橙子", "新鲜桃子", "腐烂桃子", "半熟桃子",
                           "半腐烂桃子",
                           "新鲜梨子", "腐烂梨子", "半熟梨子", "半腐烂梨子", "成熟葡萄", "未成熟葡萄"]  # 定义类名列表
        self.count_table = []  # 存储识别计数的列表
        ...
        # 加载训练的模型权重
        self.model.load_model(model_path=abs_path("weights/ripeness-yolov8n.pt", path_type="current"))
            ...
            if col == 0:  # 只在点击第一列时执行操作
                ...
                if (this_path is not None) & (res is not None) & (axes is not None):
                    ...
                    if os.path.isfile(this_path):  # 检查文件路径是否存在
                        ...
                        count = self.count_table[row]  # 获取识别计数列表中的值
    ...
    def toggle_version(self):
        ...
        QMessageBox.about(self.centralwidget,
                          "来孟阳的github",
                          "<A href='https://github.com/LionelMessiYoung10'>"
                          "https://github.com/LionelMessiYoung10</a>")  # 在消息框中显示来孟阳github的链接
    ...
    def toggle_website(self):
        ...
        #                   "作者简介",
        #                   "<A href=''>"
        #                   "来孟阳\n\n山东财经大学本科生，\n\nACM-ICPC亚洲区域赛南京站、杭州站铜牌\n\nCCPC郑州站铜牌</a>")  # 在消息框中显示作者简介
        QMessageBox.about(self.centralwidget,
                          "作者简介",
                          "<html>"
                          "来孟阳<br><br>"
                          "山东财经大学本科生，<br><br>"
                          "ACM-ICPC亚洲区域赛南京站、杭州站铜牌<br><br>"
                          "CCPC郑州站铜牌<br>"
                          "</html>")
